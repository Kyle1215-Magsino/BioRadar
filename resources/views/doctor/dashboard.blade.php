...
<div class="max-w-7xl mx-auto animate__animated animate__fadeIn">
    <h1 class="text-3xl font-bold text-[#1B9AAA] mb-8">Doctor Dashboard</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="stat-card bg-white rounded-2xl shadow-lg p-6 transform hover:-translate-y-2 transition duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-5">
                    <h3 class="text-gray-500 text-sm font-medium">Pending Assessments</h3>
                    <p class="text-3xl font-semibold bg-[#40C9A2] bg-clip-text text-transparent">{{ $stats['pending_assessments'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card bg-white rounded-2xl shadow-lg p-6 transform hover:-translate-y-2 transition duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-5">
                    ...
                    <p class="text-3xl font-semibold text-[#1B9AAA]">{{ $stats['total_patients'] }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-[#D3F9D8]">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <a href="{{ route('doctor.assessments.pending') }}" class="flex items-center p-4 bg-[#B2F2BB] rounded-xl hover:shadow-lg transform hover:-translate-y-1 transition duration-300 flex-1">
                <svg class="h-8 w-8 text-[#1B9AAA]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                </svg>
                <div class="ml-4">
                    <h3 class="font-semibold text-[#1B9AAA]">Review Pending Cases</h3>
                    <p class="text-sm text-gray-600">Evaluate patient assessments</p>
                </div>
            </a>
            <a href="{{ route('doctor.assessments') }}" class="flex items-center p-4 bg-[#40C9A2] rounded-xl hover:shadow-lg transform hover:-translate-y-1 transition duration-300 flex-1">
                <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                <div class="ml-4">
                    <h3 class="font-semibold text-white">View All Assessments</h3>
                    <p class="text-sm text-white opacity-90">Browse assessment history</p>
                </div>
            </a>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
                    ...
                    <tbody class="bg-white divide-y divide-[#D3F9D8]">
                        ...
                        <tr class="hover:bg-[#D3F9D8] transition duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('doctor.assessment.review', $assessment) }}" class="text-[#1B9AAA] hover:text-[#40C9A2] font-semibold transition duration-200">Review</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">No assessments have been assigned to you yet.</p>
                </div>
            @endif
        </div>
    </div>
